...
<head>
    ...
    <title>Segnalazione Cancellata #{{ $ticket->id }}</title>
</head>
<body bgcolor="#f4f4f4">
...
<table border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#ffffff">
    ...
    {{-- ===== HEADER ===== --}}
    <tr>
        <td colspan="2" bgcolor="{{ $header_color }}" style="background-color:{{ $header_color }};padding:22px 24px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td valign="middle">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr><td style="padding-bottom:6px;color:#ffffff;font-size:11px;font-family:Arial,Helvetica,sans-serif;">CANCELLATA &mdash; {{ $type_label }}</td></tr>
                            ...
                            <tr><td style="color:#ffffff;font-size:13px;font-family:Arial,Helvetica,sans-serif;">Cancellata il {{ $ticket->updated_at }}</td></tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td bgcolor="#ffffff" style="background-color:#ffffff;padding:9px 16px;">
                                    <a href="https://{{ $site_url }}/resources/tickets/{{ $ticket->id }}"
                                       style="color:{{ $header_color }};font-size:13px;text-decoration:none;font-family:Arial,Helvetica,sans-serif;"><b>Apri nel portale &rarr;</b></a>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    {{-- ===== DOVE INTERVENIRE ===== --}}
    <tr>
        <td colspan="2" bgcolor="#f0f0f0" style="background-color:#f0f0f0;padding:9px 14px 9px 18px;font-size:11px;color:#555555;font-family:Arial,Helvetica,sans-serif;border-left:4px solid {{ $header_color }};"><b>DOVE INTERVENIRE</b></td>
    </tr>
    ...
    <tr>
        <td colspan="2" bgcolor="#f0f0f0" style="background-color:#f0f0f0;padding:9px 14px 9px 18px;font-size:11px;color:#555555;font-family:Arial,Helvetica,sans-serif;border-left:4px solid {{ $header_color }};"><b>DETTAGLI SEGNALAZIONE</b></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2" align="center" style="padding:20px 24px;">
            <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                    <td bgcolor="{{ $header_color }}" style="background-color:{{ $header_color }};padding:13px 36px;">
                        <a href="https://{{ $site_url }}/resources/tickets/{{ $ticket->id }}"
